...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        final var mineIndexesStack = new HashSet<Integer>();
        final var alreadyDetonated = IntStream.range(0, n).mapToObj(i -> false).collect(Collectors.toList());
        mineIndexesStack.add(k);
        while (!mineIndexesStack.isEmpty()) {
            final var currentIndex = mineIndexesStack.stream().findFirst().orElseThrow();
            ...
            mineIndexesStack.remove(currentIndex);
