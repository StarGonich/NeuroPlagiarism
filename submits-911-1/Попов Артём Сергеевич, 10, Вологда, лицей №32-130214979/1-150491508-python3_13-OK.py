...
if h1>h2:
	for i in range (h1,25+h2):
		for j in range (0,60):
			if time(i%24,j)==True and ((i!=h1 and i!=h2+24) or (i==h1 and j>=m1) or (i==h2+24 and j<=m2)):
				k+=1
if h1<h2:
	for i in range (h1, h2+1):
		for j in range(0,60):
			if time(i%24,j)==True and ((i!=h1 and i%24!=h2) or (i==h1 and j>=m1) or (i%24==h2 and j<=m2)):
				k+=1
if h1==h2 and m1>m2:
